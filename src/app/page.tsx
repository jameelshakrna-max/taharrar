              ...
              {!otpSent ? (
                <form onSubmit={handleSendOtp} className="space-y-5">
                  ...
                  <Input
                    ...
                    className="h-12 bg-gray-800/50 border-gray-700 text-white placeholder:text-gray-500 focus:border-emerald-500 text-right text-base"
                    dir="ltr"
                  />
                  {error && (
                  ...
                  <Button
                    type="submit"
                    disabled={loading}
                    className="w-full h-12 bg-gradient-to-l from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold text-lg rounded-xl shadow-lg shadow-emerald-500/25"
                  >
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-5">
                  ...
                  <Input
                    ...
                    className="h-16 bg-gray-800/50 border-gray-700 text-white placeholder:text-gray-500 focus:border-emerald-500 text-center text-3xl tracking-[0.5em] font-mono"
                    dir="ltr"
                  />
                  {error && (
                    <p className="text-red-400 text-sm text-center bg-red-500/10 rounded-lg p-2">{error}</p>
              ...
              <div className="max-w-xs mx-auto">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-xs text-gray-400">
                    التقدم نحو الهدف ({user.goalStreak} يوم)
                  </span>
              ...
              <CardContent className="p-4 text-center">
                <p
                  className={`text-sm font-medium ${
                    messageType === 'success' ? 'text-emerald-300' : 'text-orange-300'
                  }`}
                >
                  {message}
                </p>
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 pb-24 pt-2">
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab !== 'home' && (
            ...
            >
              <h2 className="text-2xl font-bold text-white">جاري استعادة هذا القسم...</h2>
            </motion.div>
          )}
        </AnimatePresence>
